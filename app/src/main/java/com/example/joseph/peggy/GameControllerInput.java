...
public class GameControllerInput extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGame = (GameView) findViewById(R.id.gameViewView);

        mSummaryList = (ListView) findViewById(R.id.gameViewSummary);
    ...
    private static class SummaryAdapter extends BaseAdapter {
        ...
        private static class Heading extends Item {
            ...
            public Heading(int itemId, String label) {
                super(itemId, R.layout.game_view_heading);
                mLabel = label;
            }
        ...
        private static class TextColumn extends Item {
            ...
            public TextColumn(int itemId, String label) {
                super(itemId, R.layout.game_view_column);
                mLabel = label;
            }
            ...
            @Override
            public void initView(View view) {
                TextView textView = (TextView) view.findViewById(R.id.gameViewColumn);
                textView.setText(mLabel);

                mContentView = (TextView) view.findViewById(R.id.gameViewColumnLabel);
            }
